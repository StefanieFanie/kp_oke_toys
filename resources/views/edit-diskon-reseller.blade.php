...
<div>
    ...
    <form action="{{ route('update-diskon-reseller') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" min="1" max="50" class="form-control" id="diskon_reseller" name="diskon_reseller" value="{{ isset($diskon_reseller) ? $diskon_reseller : '' }}" autocomplete="off" required>
        </div>
