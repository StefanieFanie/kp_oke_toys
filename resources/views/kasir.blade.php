        ...
        <div class="col-md-8 pe-md-2">
            <div class="mb-3 d-flex">
                <div class="input-group flex-grow-1 me-2"style="border:1px solid #8EABFF; background-color:#F4F7FF; border-radius:7px;">
                    ...
                    <input type="text" class="form-control border-start-0" placeholder="Cari produk..." aria-label="Search products">
                </div>
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="filterDropdown">
                        <li><a class="dropdown-item" href="#">Mainan Edukasi</a></li>
                        <li><a class="dropdown-item" href="#">Mainan Kreatif</a></li>
                        <li><a class="dropdown-item" href="#">Mainan Klasik</a></li>
                        <li><a class="dropdown-item" href="#">Mainan Slime</a></li>
                        <li><a class="dropdown-item" href="#">Mainan Kendaraan</a></li>
                    </ul>
                </div>
            </div>
                            ...
                            <tbody>
                                <tr>
                                    <td class="align-middle text-center">
                                        <div class="product-image" style="width: 50px; height: 50px; background-color: #d1e7c6; border-radius: 5px; margin: 0 auto;"></div>
                                    </td>
                                    <td class="align-middle text-center">Yoyo</td>
                                ...
                                <tr>
                                    <td class="align-middle text-center">
                                        <div class="product-image" style="width: 50px; height: 50px; background-color: #ffd9d9; border-radius: 5px; margin: 0 auto;"></div>
                                    </td>
                                    <td class="align-middle text-center">Ice Cream Squishy</td>
                                    <td class="align-middle text-center">32</td>
                                    <td class="align-middle text-center">Rp 25.000</td>
                                    <td class="align-middle text-center" style="width: 100px;">
                                        <input type="number" class="form-control form-control-sm text-center" value="0" min="0" max="32" style="width: 60px; margin: 0 auto;">
                                    </td>
                                    <td class="align-middle text-center">
                                        <button class="btn btn-md" style="background-color: #A1C6FF; border:1px solid #8EABFF;box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.25);">
                                            <i class="bi bi-basket"></i>
                                ...
                                <tr>
                                    <td class="align-middle text-center">
                                        <div class="product-image" style="width: 50px; height: 50px; background-color: #fff8c2; border-radius: 5px; margin: 0 auto;"></div>
                                    </td>
                                    <td class="align-middle text-center">Congklak</td>
                                    <td class="align-middle text-center">44</td>
                                    <td class="align-middle text-center">Rp 15.000</td>
                                    <td class="align-middle text-center" style="width: 100px;">
                                        <input type="number" class="form-control form-control-sm text-center" value="0" min="0" max="44" style="width: 60px; margin: 0 auto;">
                                    </td>
                                    <td class="align-middle text-center">
                                        <button class="btn btn-md" style="background-color: #A1C6FF; border:1px solid #8EABFF;box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.25);">
                                            <i class="bi bi-basket"></i>
                                ...
                                <tr>
                                    <td class="align-middle text-center">
                                        <div class="product-image" style="width: 50px; height: 50px; background-color: #d1ceff; border-radius: 5px; margin: 0 auto;"></div>
                                    </td>
                                    <td class="align-middle text-center">Monopoli</td>
                                    <td class="align-middle text-center">15</td>
                                    <td class="align-middle text-center">Rp 20.000</td>
                                    <td class="align-middle text-center" style="width: 100px;">
                                        <input type="number" class="form-control form-control-sm text-center" value="0" min="0" max="15" style="width: 60px; margin: 0 auto;">
                                    </td>
                                    <td class="align-middle text-center">
                                        <button class="btn btn-md" style="background-color: #A1C6FF; border:1px solid #8EABFF;box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.25);">
                                            <i class="bi bi-basket"></i>
                                ...
                                <tr>
                                    <td class="align-middle text-center">
                                        <div class="product-image" style="width: 50px; height: 50px; background-color: #c2f5ff; border-radius: 5px; margin: 0 auto;"></div>
                                    </td>
                                    <td class="align-middle text-center">Mobil-mobilan</td>
                                    <td class="align-middle text-center">78</td>
                                    <td class="align-middle text-center">Rp 10.000</td>
                                    <td class="align-middle text-center" style="width: 100px;">
                                        <input type="number" class="form-control form-control-sm text-center" value="0" min="0" max="78" style="width: 60px; margin: 0 auto;">
                                    </td>
                                    <td class="align-middle text-center">
                                        <button class="btn btn-md" style="background-color: #A1C6FF; border:1px solid #8EABFF;box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.25);">
                                            <i class="bi bi-basket"></i>
                                ...
                                <tr>
                                    <td class="align-middle text-center">
                                        <div class="product-image" style="width: 50px; height: 50px; background-color: #ffd9c2; border-radius: 5px; margin: 0 auto;"></div>
                                    </td>
                                    <td class="align-middle text-center">Lego my world</td>
                                    <td class="align-middle text-center">4</td>
                                    <td class="align-middle text-center">Rp 156.000</td>
                                    <td class="align-middle text-center" style="width: 100px;">
                                        <input type="number" class="form-control form-control-sm text-center" value="0" min="0" max="44" style="width: 60px; margin: 0 auto;">
                                    </td>
                                    <td class="align-middle text-center">
