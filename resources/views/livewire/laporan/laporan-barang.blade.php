        ...
        <table class="table table-bordered border-secondary table-sm">
            ...
            <tbody>
                <tr>
                    ...
                    <td>xxx</td>
                    <td>
                        <div class="alert alert-danger" role="alert" style="padding:0; width: 70px; margin:0">
                            Keluar
                        </div>
                    </td>
                    <td>5</td>
                ...
                <tr>
                    ...
                    <td>xxx</td>
                    <td>
                        <div class="alert alert-success" role="alert" style="padding:0; width: 70px; margin:0">
                            Masuk
                        </div>
                    </td>
                    <td>12</td>
